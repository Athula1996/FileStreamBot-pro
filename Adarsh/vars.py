...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('6298021090:AAEyF6rVpR4X4X3pKMsUDrHIvIJsjKqp1yU'))
    name = str(getenv('name', 'Pdisk_Link_bot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('-1001524622686'))
    PORT = int(getenv('PORT', 8080))
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'https://able-mommy-as772685.koyeb.app'))
    ...
    DATABASE_URL = str(getenv('mongodb+srv://akash:official@cluster0.iwbsajx.mongodb.net/?retryWrites=true&w=majority'))
